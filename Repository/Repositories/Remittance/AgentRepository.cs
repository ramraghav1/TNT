...
namespace Repository.Repositories.Remittance
{
    public class AgentRepository : IAgentRepository
    {
        ...
        {
            string sql = @"
                INSERT INTO agents (name, country_id, contact_person, contact_email, contact_phone, created_at)
                VALUES (@Name, @CountryId, @ContactPerson, @ContactEmail, @ContactPhone, NOW())
                RETURNING id;";
